      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h1 className="text-AscendColor text-3xl title-font font-medium mb-1">
              {name}
            </h1>
            ...
            <p className="leading-relaxed">
              {desc ??
                "Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, ex voluptates distinctio fugiatexcepturi velit enim perferendis possimus quam quibusdamlaudantium vel eveniet iste asperiores optio corporis alias undeipsum."}
            </p>
